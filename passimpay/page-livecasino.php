       ...
       <section class="main__tab__slide">
        <ul class="nav nav-tabs" id="myTabmain" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="main-tab8cas" data-bs-toggle="tab" data-bs-target="#casinot8" type="button" role="tab"  aria-selected="false">
            ...
            <li class="nav-item" role="presentation">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="main-tabcass" data-bs-toggle="tab" data-bs-target="#casinot7" type="button" role="tab"  aria-selected="false">
            ...
            <div class="row g-0">
                <div class="casino__tab__area">
                    <div class="tab-content" id="nav-tabCcasino">
                        <!--all games-->
                        <div class="tab-pane mt__30 pb-80 fade text-white" id="casinot8" role="tabpanel" aria-labelledby="casinot1" tabindex="0">
                            <!--Top Games-->
                        ...
                        <!--Live games-->
                        <div class="tab-pane fade show active text-white mt__30" id="casinot7" role="tabpanel" aria-labelledby="casinot7" tabindex="0">
                            <!--Top Games-->
                            <div class="common__head mb__30">
                                <span class="icons"><i class="icon-live"></i></span>
                                <span>Top Games</span>
