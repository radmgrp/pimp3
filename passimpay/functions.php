...
require get_template_directory() . '/inc/block-patterns.php';
  ...
  wp_enqueue_style( 'auto-main', get_theme_file_uri( '/assets/css/all.min.css' ), array(), '12' );
  wp_enqueue_style( 'auto-main2', get_theme_file_uri( '/assets/css/animate.css' ), array(), '12' );
  wp_enqueue_style( 'auto-main3', get_theme_file_uri( '/assets/css/bootstrap.min.css' ), array(), '12' );
     wp_enqueue_style( 'auto-main6', get_theme_file_uri( '/assets/css/owl.carousel.min.css' ), array(), '12' );
    wp_enqueue_style( 'auto-main61', get_theme_file_uri( '/assets/css/magnific-popup.css' ), array(), '12' );
    wp_enqueue_style( 'auto-main63', get_theme_file_uri( '/assets/css/owl.theme.default.css' ), array(), '12' );
    wp_enqueue_style( 'auto-main67', get_theme_file_uri( '/assets/css/nice-select.css' ), array(), '12' );
    wp_enqueue_style( 'auto-main7', get_theme_file_uri( '/assets/glyphter-font/css/Glyphter.css'), array(), '12'  );
     
  
    wp_enqueue_script( 'auto-jquery1', get_theme_file_uri( '/assets/js/jquery-3.6.0.min.js' ), array(), '20230614' );
   wp_enqueue_script( 'auto-jquery2', get_theme_file_uri( '/assets/js/bootstrap.bundle.min.js' ), array(), '20230614' );
  wp_enqueue_script( 'auto-jquery3', get_theme_file_uri( '/assets/js/jquery.magnific-popup.min.js' ), array(), '20230614' );
 wp_enqueue_script( 'auto-jquery4', get_theme_file_uri( '/assets/js/owl.carousel.min.js' ), array(), '20230614' );
 wp_enqueue_script( 'auto-jquery5', get_theme_file_uri( '/assets/js/jquery.nice-select.min.js' ), array(), '20230614' );
  wp_enqueue_script( 'auto-jquery6', get_theme_file_uri( '/assets/js/wow.min.js' ), array(), '20230614' );
 wp_enqueue_script( 'auto-jquery7', get_theme_file_uri( '/assets/js/jquery-ui.min.js' ), array(), '20230614' );
wp_enqueue_script( 'auto-jquery8', get_theme_file_uri( '/assets/js/api.js' ), array(), '20230614' );



function logout_to_optional_redirect_slug_function( $atts, $redirect_slug = null ) {
$redirect_slug=$_SERVER['REQUEST_URI'];
    $redirect_full_url = get_site_url(null, '/', 'http') . $redirect_slug;
    $logout_url = wp_logout_url($redirect_full_url);
    $logout_hyperlink = $logout_url;
